...
//
// Table class for t03_kelurahan
//
class ct03_kelurahan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't03_kelurahan';
		$this->TableName = 't03_kelurahan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t03_kelurahan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t03_kelurahan', 't03_kelurahan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// provinsi_id
		$this->provinsi_id = new cField('t03_kelurahan', 't03_kelurahan', 'x_provinsi_id', 'provinsi_id', '`provinsi_id`', '`provinsi_id`', 3, -1, FALSE, '`provinsi_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kabupatenkota_id
		$this->kabupatenkota_id = new cField('t03_kelurahan', 't03_kelurahan', 'x_kabupatenkota_id', 'kabupatenkota_id', '`kabupatenkota_id`', '`kabupatenkota_id`', 3, -1, FALSE, '`kabupatenkota_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kecamatan_id
		$this->kecamatan_id = new cField('t03_kelurahan', 't03_kelurahan', 'x_kecamatan_id', 'kecamatan_id', '`kecamatan_id`', '`kecamatan_id`', 3, -1, FALSE, '`kecamatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Nama
		$this->Nama = new cField('t03_kelurahan', 't03_kelurahan', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t03_kelurahan`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t03_kelurahanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t03_kelurahanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t03_kelurahanadd.php?" . $this->UrlParm($parm);
		else
			$url = "t03_kelurahanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t03_kelurahanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t03_kelurahanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t03_kelurahandelete.php", $this->UrlParm());
	}
