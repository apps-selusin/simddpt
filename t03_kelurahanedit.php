...
$t03_kelurahan_edit = NULL; // Initialize page object first

class ct03_kelurahan_edit extends ct03_kelurahan {
	...
	// Page object name
	var $PageObjName = 't03_kelurahan_edit';
...
// Create page object
if (!isset($t03_kelurahan_edit)) $t03_kelurahan_edit = new ct03_kelurahan_edit();

// Page init
$t03_kelurahan_edit->Page_Init();

// Page main
$t03_kelurahan_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_kelurahan_edit->Page_Render();
?>
...
var CurrentForm = ft03_kelurahanedit = new ew_Form("ft03_kelurahanedit", "edit");

// Validate form
ft03_kelurahanedit.Validate = function() {
...
ft03_kelurahanedit.Form_CustomValidate = 
...
ft03_kelurahanedit.ValidateRequired = true;
<?php } else { ?>
ft03_kelurahanedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft03_kelurahanedit.Lists["x_provinsi_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kabupatenkota_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t00_provinsi"};
ft03_kelurahanedit.Lists["x_kabupatenkota_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_provinsi_id"],"ChildFields":["x_kecamatan_id"],"FilterFields":["x_provinsi_id"],"Options":[],"Template":"","LinkTable":"t01_kabupatenkota"};
ft03_kelurahanedit.Lists["x_kecamatan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_kabupatenkota_id"],"ChildFields":[],"FilterFields":["x_kabupatenkota_id"],"Options":[],"Template":"","LinkTable":"t02_kecamatan"};
...
<?php if (!$t03_kelurahan_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t03_kelurahan_edit->ShowPageHeader(); ?>
<?php
$t03_kelurahan_edit->ShowMessage();
?>
<?php if (!$t03_kelurahan_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t03_kelurahan_edit->Pager)) $t03_kelurahan_edit->Pager = new cPrevNextPager($t03_kelurahan_edit->StartRec, $t03_kelurahan_edit->DisplayRecs, $t03_kelurahan_edit->TotalRecs) ?>
<?php if ($t03_kelurahan_edit->Pager->RecordCount > 0 && $t03_kelurahan_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t03_kelurahan_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t03_kelurahan_edit->PageUrl() ?>start=<?php echo $t03_kelurahan_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t03_kelurahan_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t03_kelurahan_edit->PageUrl() ?>start=<?php echo $t03_kelurahan_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t03_kelurahan_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t03_kelurahan_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t03_kelurahan_edit->PageUrl() ?>start=<?php echo $t03_kelurahan_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t03_kelurahan_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t03_kelurahan_edit->PageUrl() ?>start=<?php echo $t03_kelurahan_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t03_kelurahan_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft03_kelurahanedit" id="ft03_kelurahanedit" class="<?php echo $t03_kelurahan_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_kelurahan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_kelurahan_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t03_kelurahan" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t03_kelurahan->id->CurrentValue) ?>">
<?php if (!$t03_kelurahan_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t03_kelurahan_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t03_kelurahan_edit->Pager)) $t03_kelurahan_edit->Pager = new cPrevNextPager($t03_kelurahan_edit->StartRec, $t03_kelurahan_edit->DisplayRecs, $t03_kelurahan_edit->TotalRecs) ?>
<?php if ($t03_kelurahan_edit->Pager->RecordCount > 0 && $t03_kelurahan_edit->Pager->Visible) { ?>
...
<script type="text/javascript">
ft03_kelurahanedit.Init();
</script>
<?php
$t03_kelurahan_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t03_kelurahan_edit->Page_Terminate();
?>
