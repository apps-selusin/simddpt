...
$t03_kelurahan_view = NULL; // Initialize page object first

class ct03_kelurahan_view extends ct03_kelurahan {
	...
	// Page object name
	var $PageObjName = 't03_kelurahan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t03_kelurahanlist.php"); // Return to list page
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t03_kelurahanlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t03_kelurahanlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t03_kelurahan_view)) $t03_kelurahan_view = new ct03_kelurahan_view();

// Page init
$t03_kelurahan_view->Page_Init();

// Page main
$t03_kelurahan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_kelurahan_view->Page_Render();
?>
...
var CurrentForm = ft03_kelurahanview = new ew_Form("ft03_kelurahanview", "view");

// Form_CustomValidate event
ft03_kelurahanview.Form_CustomValidate = 
...
ft03_kelurahanview.ValidateRequired = true;
<?php } else { ?>
ft03_kelurahanview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft03_kelurahanview.Lists["x_provinsi_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kabupatenkota_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t00_provinsi"};
ft03_kelurahanview.Lists["x_kabupatenkota_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kecamatan_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_kabupatenkota"};
ft03_kelurahanview.Lists["x_kecamatan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_kecamatan"};
...
<?php if ($t03_kelurahan->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t03_kelurahan_view->IsModal) { ?>
<?php if ($t03_kelurahan->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t03_kelurahan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t03_kelurahan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t03_kelurahan_view->IsModal) { ?>
<?php if ($t03_kelurahan->Export == "") { ?>
...
<?php } ?>
<?php $t03_kelurahan_view->ShowPageHeader(); ?>
<?php
$t03_kelurahan_view->ShowMessage();
?>
<?php if (!$t03_kelurahan_view->IsModal) { ?>
<?php if ($t03_kelurahan->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t03_kelurahan_view->Pager)) $t03_kelurahan_view->Pager = new cPrevNextPager($t03_kelurahan_view->StartRec, $t03_kelurahan_view->DisplayRecs, $t03_kelurahan_view->TotalRecs) ?>
<?php if ($t03_kelurahan_view->Pager->RecordCount > 0 && $t03_kelurahan_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t03_kelurahan_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t03_kelurahan_view->PageUrl() ?>start=<?php echo $t03_kelurahan_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t03_kelurahan_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t03_kelurahan_view->PageUrl() ?>start=<?php echo $t03_kelurahan_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t03_kelurahan_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t03_kelurahan_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t03_kelurahan_view->PageUrl() ?>start=<?php echo $t03_kelurahan_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t03_kelurahan_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t03_kelurahan_view->PageUrl() ?>start=<?php echo $t03_kelurahan_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t03_kelurahan_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft03_kelurahanview" id="ft03_kelurahanview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_kelurahan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_kelurahan_view->Token ?>">
<?php } ?>
...
<?php if ($t03_kelurahan->provinsi_id->Visible) { // provinsi_id ?>
	<tr id="r_provinsi_id">
		<td><span id="elh_t03_kelurahan_provinsi_id"><?php echo $t03_kelurahan->provinsi_id->FldCaption() ?></span></td>
...
<?php echo $t03_kelurahan->provinsi_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_kelurahan->kabupatenkota_id->Visible) { // kabupatenkota_id ?>
	<tr id="r_kabupatenkota_id">
		<td><span id="elh_t03_kelurahan_kabupatenkota_id"><?php echo $t03_kelurahan->kabupatenkota_id->FldCaption() ?></span></td>
...
<?php echo $t03_kelurahan->kabupatenkota_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_kelurahan->kecamatan_id->Visible) { // kecamatan_id ?>
	<tr id="r_kecamatan_id">
		<td><span id="elh_t03_kelurahan_kecamatan_id"><?php echo $t03_kelurahan->kecamatan_id->FldCaption() ?></span></td>
...
<?php echo $t03_kelurahan->kecamatan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t03_kelurahan->Nama->Visible) { // Nama ?>
	<tr id="r_Nama">
		<td><span id="elh_t03_kelurahan_Nama"><?php echo $t03_kelurahan->Nama->FldCaption() ?></span></td>
...
<?php echo $t03_kelurahan->Nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t03_kelurahan->Export == "") { ?>
<script type="text/javascript">
ft03_kelurahanview.Init();
</script>
<?php } ?>
<?php
$t03_kelurahan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t03_kelurahan->Export == "") { ?>
...
<?php
$t03_kelurahan_view->Page_Terminate();
?>
