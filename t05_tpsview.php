...
$t05_tps_view = NULL; // Initialize page object first

class ct05_tps_view extends ct05_tps {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t05_tpslist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t05_tpslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t05_tps_view)) $t05_tps_view = new ct05_tps_view();

// Page init
$t05_tps_view->Page_Init();

// Page main
$t05_tps_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t05_tps_view->Page_Render();
?>
...
var CurrentForm = ft05_tpsview = new ew_Form("ft05_tpsview", "view");

// Form_CustomValidate event
ft05_tpsview.Form_CustomValidate = 
...
ft05_tpsview.ValidateRequired = true;
<?php } else { ?>
ft05_tpsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft05_tpsview.Lists["x_provinsi_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kabupatenkota_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t00_provinsi"};
ft05_tpsview.Lists["x_kabupatenkota_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kecamatan_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_kabupatenkota"};
ft05_tpsview.Lists["x_kecamatan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kelurahan_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_kecamatan"};
ft05_tpsview.Lists["x_kelurahan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t03_kelurahan"};
...
<?php if ($t05_tps->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t05_tps_view->IsModal) { ?>
<?php if ($t05_tps->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t05_tps_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t05_tps_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t05_tps_view->IsModal) { ?>
<?php if ($t05_tps->Export == "") { ?>
...
<?php } ?>
<?php $t05_tps_view->ShowPageHeader(); ?>
<?php
$t05_tps_view->ShowMessage();
?>
<?php if (!$t05_tps_view->IsModal) { ?>
<?php if ($t05_tps->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t05_tps_view->Pager)) $t05_tps_view->Pager = new cPrevNextPager($t05_tps_view->StartRec, $t05_tps_view->DisplayRecs, $t05_tps_view->TotalRecs) ?>
<?php if ($t05_tps_view->Pager->RecordCount > 0 && $t05_tps_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t05_tps_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t05_tps_view->PageUrl() ?>start=<?php echo $t05_tps_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t05_tps_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t05_tps_view->PageUrl() ?>start=<?php echo $t05_tps_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t05_tps_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t05_tps_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t05_tps_view->PageUrl() ?>start=<?php echo $t05_tps_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t05_tps_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t05_tps_view->PageUrl() ?>start=<?php echo $t05_tps_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t05_tps_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft05_tpsview" id="ft05_tpsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t05_tps_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t05_tps_view->Token ?>">
<?php } ?>
...
<?php if ($t05_tps->provinsi_id->Visible) { // provinsi_id ?>
	<tr id="r_provinsi_id">
		<td><span id="elh_t05_tps_provinsi_id"><?php echo $t05_tps->provinsi_id->FldCaption() ?></span></td>
...
<?php echo $t05_tps->provinsi_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t05_tps->kabupatenkota_id->Visible) { // kabupatenkota_id ?>
	<tr id="r_kabupatenkota_id">
		<td><span id="elh_t05_tps_kabupatenkota_id"><?php echo $t05_tps->kabupatenkota_id->FldCaption() ?></span></td>
...
<?php echo $t05_tps->kabupatenkota_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t05_tps->kecamatan_id->Visible) { // kecamatan_id ?>
	<tr id="r_kecamatan_id">
		<td><span id="elh_t05_tps_kecamatan_id"><?php echo $t05_tps->kecamatan_id->FldCaption() ?></span></td>
...
<?php echo $t05_tps->kecamatan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t05_tps->kelurahan_id->Visible) { // kelurahan_id ?>
	<tr id="r_kelurahan_id">
		<td><span id="elh_t05_tps_kelurahan_id"><?php echo $t05_tps->kelurahan_id->FldCaption() ?></span></td>
...
<?php echo $t05_tps->kelurahan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
