...
//
// Table class for t05_tps
//
class ct05_tps extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't05_tps';
		$this->TableName = 't05_tps';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t05_tps`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t05_tps', 't05_tps', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// provinsi_id
		$this->provinsi_id = new cField('t05_tps', 't05_tps', 'x_provinsi_id', 'provinsi_id', '`provinsi_id`', '`provinsi_id`', 3, -1, FALSE, '`provinsi_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->provinsi_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['provinsi_id'] = &$this->provinsi_id;

		// kabupatenkota_id
		$this->kabupatenkota_id = new cField('t05_tps', 't05_tps', 'x_kabupatenkota_id', 'kabupatenkota_id', '`kabupatenkota_id`', '`kabupatenkota_id`', 3, -1, FALSE, '`kabupatenkota_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kecamatan_id
		$this->kecamatan_id = new cField('t05_tps', 't05_tps', 'x_kecamatan_id', 'kecamatan_id', '`kecamatan_id`', '`kecamatan_id`', 3, -1, FALSE, '`kecamatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->kecamatan_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kecamatan_id'] = &$this->kecamatan_id;

		// kelurahan_id
		$this->kelurahan_id = new cField('t05_tps', 't05_tps', 'x_kelurahan_id', 'kelurahan_id', '`kelurahan_id`', '`kelurahan_id`', 3, -1, FALSE, '`kelurahan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kelurahan_id->Sortable = TRUE; // Allow sort
		$this->kelurahan_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->kelurahan_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->kelurahan_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kelurahan_id'] = &$this->kelurahan_id;

		// TPS
		$this->TPS = new cField('t05_tps', 't05_tps', 'x_TPS', 'TPS', '`TPS`', '`TPS`', 200, -1, FALSE, '`TPS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TPS->Sortable = TRUE; // Allow sort
		$this->fields['TPS'] = &$this->TPS;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t05_tps`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t05_tpsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t05_tpsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t05_tpsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t05_tpsadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t05_tpsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t05_tpsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t05_tpsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->TPS->EditValue = $this->TPS->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->kecamatan_id->Exportable) $Doc->ExportCaption($this->kecamatan_id);
					if ($this->kelurahan_id->Exportable) $Doc->ExportCaption($this->kelurahan_id);
					if ($this->TPS->Exportable) $Doc->ExportCaption($this->TPS);
				} else {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->kecamatan_id->Exportable) $Doc->ExportField($this->kecamatan_id);
						if ($this->kelurahan_id->Exportable) $Doc->ExportField($this->kelurahan_id);
						if ($this->TPS->Exportable) $Doc->ExportField($this->TPS);
					} else {
