...
$t03_kelurahan_delete = NULL; // Initialize page object first

class ct03_kelurahan_delete extends ct03_kelurahan {
	...
	// Page object name
	var $PageObjName = 't03_kelurahan_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t03_kelurahanlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t03_kelurahan class, t03_kelurahaninfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t03_kelurahanlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t03_kelurahan_delete)) $t03_kelurahan_delete = new ct03_kelurahan_delete();

// Page init
$t03_kelurahan_delete->Page_Init();

// Page main
$t03_kelurahan_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t03_kelurahan_delete->Page_Render();
?>
...
var CurrentForm = ft03_kelurahandelete = new ew_Form("ft03_kelurahandelete", "delete");

// Form_CustomValidate event
ft03_kelurahandelete.Form_CustomValidate = 
...
ft03_kelurahandelete.ValidateRequired = true;
<?php } else { ?>
ft03_kelurahandelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft03_kelurahandelete.Lists["x_provinsi_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kabupatenkota_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t00_provinsi"};
ft03_kelurahandelete.Lists["x_kabupatenkota_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kecamatan_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_kabupatenkota"};
ft03_kelurahandelete.Lists["x_kecamatan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t02_kecamatan"};
...
<?php $t03_kelurahan_delete->ShowPageHeader(); ?>
<?php
$t03_kelurahan_delete->ShowMessage();
?>
<form name="ft03_kelurahandelete" id="ft03_kelurahandelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t03_kelurahan_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t03_kelurahan_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t03_kelurahan">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t03_kelurahan_delete->RecKeys as $key) { ?>
...
<?php if ($t03_kelurahan->provinsi_id->Visible) { // provinsi_id ?>
		<th><span id="elh_t03_kelurahan_provinsi_id" class="t03_kelurahan_provinsi_id"><?php echo $t03_kelurahan->provinsi_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t03_kelurahan->kabupatenkota_id->Visible) { // kabupatenkota_id ?>
		<th><span id="elh_t03_kelurahan_kabupatenkota_id" class="t03_kelurahan_kabupatenkota_id"><?php echo $t03_kelurahan->kabupatenkota_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t03_kelurahan->kecamatan_id->Visible) { // kecamatan_id ?>
		<th><span id="elh_t03_kelurahan_kecamatan_id" class="t03_kelurahan_kecamatan_id"><?php echo $t03_kelurahan->kecamatan_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t03_kelurahan->Nama->Visible) { // Nama ?>
		<th><span id="elh_t03_kelurahan_Nama" class="t03_kelurahan_Nama"><?php echo $t03_kelurahan->Nama->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t03_kelurahan_delete->RecCnt = 0;
$i = 0;
while (!$t03_kelurahan_delete->Recordset->EOF) {
	$t03_kelurahan_delete->RecCnt++;
	$t03_kelurahan_delete->RowCnt++;

	// Set row properties
	$t03_kelurahan->ResetAttrs();
	$t03_kelurahan->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t03_kelurahan_delete->LoadRowValues($t03_kelurahan_delete->Recordset);

	// Render row
	$t03_kelurahan_delete->RenderRow();
?>
	<tr<?php echo $t03_kelurahan->RowAttributes() ?>>
<?php if ($t03_kelurahan->provinsi_id->Visible) { // provinsi_id ?>
		<td<?php echo $t03_kelurahan->provinsi_id->CellAttributes() ?>>
<span id="el<?php echo $t03_kelurahan_delete->RowCnt ?>_t03_kelurahan_provinsi_id" class="t03_kelurahan_provinsi_id">
...
<?php } ?>
<?php if ($t03_kelurahan->kabupatenkota_id->Visible) { // kabupatenkota_id ?>
		<td<?php echo $t03_kelurahan->kabupatenkota_id->CellAttributes() ?>>
<span id="el<?php echo $t03_kelurahan_delete->RowCnt ?>_t03_kelurahan_kabupatenkota_id" class="t03_kelurahan_kabupatenkota_id">
...
<?php } ?>
<?php if ($t03_kelurahan->kecamatan_id->Visible) { // kecamatan_id ?>
		<td<?php echo $t03_kelurahan->kecamatan_id->CellAttributes() ?>>
<span id="el<?php echo $t03_kelurahan_delete->RowCnt ?>_t03_kelurahan_kecamatan_id" class="t03_kelurahan_kecamatan_id">
...
<?php } ?>
<?php if ($t03_kelurahan->Nama->Visible) { // Nama ?>
		<td<?php echo $t03_kelurahan->Nama->CellAttributes() ?>>
<span id="el<?php echo $t03_kelurahan_delete->RowCnt ?>_t03_kelurahan_Nama" class="t03_kelurahan_Nama">
...
<?php
	$t03_kelurahan_delete->Recordset->MoveNext();
}
$t03_kelurahan_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t03_kelurahan_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft03_kelurahandelete.Init();
</script>
<?php
$t03_kelurahan_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t03_kelurahan_delete->Page_Terminate();
?>
