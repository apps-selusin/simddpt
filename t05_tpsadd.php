...
$t05_tps_add = NULL; // Initialize page object first

class ct05_tps_add extends ct05_tps {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t05_tpslist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t05_tpsview.php")
...
// Create page object
if (!isset($t05_tps_add)) $t05_tps_add = new ct05_tps_add();

// Page init
$t05_tps_add->Page_Init();

// Page main
$t05_tps_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t05_tps_add->Page_Render();
?>
...
var CurrentForm = ft05_tpsadd = new ew_Form("ft05_tpsadd", "add");

// Validate form
ft05_tpsadd.Validate = function() {
...
ft05_tpsadd.Form_CustomValidate = 
...
ft05_tpsadd.ValidateRequired = true;
<?php } else { ?>
ft05_tpsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft05_tpsadd.Lists["x_provinsi_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_kabupatenkota_id"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t00_provinsi"};
ft05_tpsadd.Lists["x_kabupatenkota_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_provinsi_id"],"ChildFields":["x_kecamatan_id"],"FilterFields":["x_provinsi_id"],"Options":[],"Template":"","LinkTable":"t01_kabupatenkota"};
ft05_tpsadd.Lists["x_kecamatan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_kabupatenkota_id"],"ChildFields":["x_kelurahan_id"],"FilterFields":["x_kabupatenkota_id"],"Options":[],"Template":"","LinkTable":"t02_kecamatan"};
ft05_tpsadd.Lists["x_kelurahan_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_kecamatan_id"],"ChildFields":[],"FilterFields":["x_kecamatan_id"],"Options":[],"Template":"","LinkTable":"t03_kelurahan"};
...
<?php } ?>
<?php $t05_tps_add->ShowPageHeader(); ?>
<?php
$t05_tps_add->ShowMessage();
?>
<form name="ft05_tpsadd" id="ft05_tpsadd" class="<?php echo $t05_tps_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t05_tps_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t05_tps_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t05_tps_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
